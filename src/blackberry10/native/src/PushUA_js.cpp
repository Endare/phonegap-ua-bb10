 ...
 * Default constructor.
 */
PushUA::PushUA(const std::string& id) : m_id(id) {
	m_pTemplateController = new webworks::UrbanAirship(this);
}
 ...
 */
string PushUA::InvokeMethod(const string& command) {
...
void PushUA::NotifyEvent(const std::string& event) {
